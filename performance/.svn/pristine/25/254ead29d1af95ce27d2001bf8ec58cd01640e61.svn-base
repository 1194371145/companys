...
<div id='actionbox' class='actionbox panel panel-sm'>
  <div class='panel-heading'>
    ...
    <div class='panel-actions'>
      <a class='btn btn-mini hand' href='javascript:;' onclick='toggleOrder(this);'> <?php echo "<span title='$lang->reverse' class='log-asc icon-'></span>";?></a>
      <a class='btn btn-mini hand' href='javascript:;' onclick='toggleShow(this);' ><?php echo "<span title='$lang->switchDisplay' class='change-show icon-'></span>";?></a>
    </div>
  </div>
