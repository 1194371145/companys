...
class baseHTML
{
     ...
     * @return string
     */
static public function selectlsj($name = '', $options = array(), $selectedItems = "", $attrib = "")
    {
        $options = (array)($options);
        if(!is_array($options) or empty($options)) return false;
        ...
        //$string = "<select name='$name' id='$name'  $attrib>\n";
        /* The options. */
        $selectedItems = ",$selectedItems,";
        foreach($options as $key => $value)
        {
    ...
    static public function inputreview($name, $value = "", $attrib = "", $status = "",$circlestatus = "")
    {
    	if($status == "close" || $circlestatus == "close")
    	{
            return $value;
    	}
    	else
    ...
    static public function textareareview($name, $value = "", $attrib = "",$status, $circlestatus = "")
    {
    	if($status == 'close' || $circlestatus == "close")
    	{
    	   return $value;
