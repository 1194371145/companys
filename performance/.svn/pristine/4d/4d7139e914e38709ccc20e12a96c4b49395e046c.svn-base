...
<table  style="width:90%;border:1px solid #000;overflow:hidden;margin-left:-1px;margin-top:-1px" align="center" border-collapse="collapse" >
...
<table  style="width:90%;border:1px solid #000;overflow:hidden;margin-left:-1px;" align="center"><tr style="border:1px solid #000;"><td colspan="8" height="10px"></td></tr></table>
<table id="job" style="width:90%;border:1px solid #000;margin-left:-1px;overflow:hidden;" align="center">
<tr>
...
<table style="width:90%;border:1px solid #000;overflow:hidden;margin-left:-1px;" align="center"><tr style="border:1px solid #000;"><td colspan="8" height="10px"></td></tr></table>
<table id="ability" style="width:90%;border:1px solid #000;;margin-left:-1px;overflow:hidden;" align="center">
<tr>
...
<td>
<?php 
if($vt->category < 5 || $get_master->manager == 'Y' )
{
   echo $vt->reviewitem;
}
?></td>
...
<table style="width:90%;border:1px solid #000;overflow:hidden;margin-left:-1px;" align="center"><tr style="border:1px solid #000;"><td colspan="8" height="10px"></td></tr></table>
<table style="width:90%;border:1px solid #000;margin-left:-1px;" align="center">
...
<td colspan="6"><?php echo html::textareareview("review_strength",$get_master->review_strength,"class='ts' readonly='readonly'",$get_master->status,$get_master->circlestatus);?></td>
</tr>
<tr>
<th style="width:195px; text-align:center;"><?php echo $lang->performance->review_improve;?></th>
<td colspan="6"><?php echo html::textareareview("review_improve",$get_master->review_improve,"class='ts' readonly='readonly'",$get_master->status,$get_master->circlestatus);?></td>
</tr>
</table> 
<table style="width:90%;border:1px solid #000;overflow:hidden;margin-left:-1px;margin-top:-1px;" align="center"><tr style="border:1px solid #000;"><td colspan="8" height="10px"></td></tr></table>
<table style="width:90%;border:1px solid #000;margin-left:-1px;margin-top:-1px;" align="center">
<tr>
...
<td colspan="6"><?php echo html::textareareview("goalitem[$value->category]",$value->goalitem,"class='tss  '",$get_master->status,$get_master->circlestatus);?></td>
<td><?php echo html::inputreview("weight[$value->category]",$value->weight*100,"class='input3  ' style='width:80%;'",$get_master->status,$get_master->circlestatus);?>%</td>
</tr>
<?php
}
}
...
<td colspan="6"><?php  echo html::textareareview("goalitem[$i]",'',"class='tss '",$get_master->status,$get_master->circlestatus);?></td>
<td><?php echo html::inputreview("weight[$i]",'',"class='input3  '",$get_master->status,$get_master->circlestatus); ?>%</td>
</tr>
<?php 
}
...
<table style="width:90%;border:1px solid #000;margin-left:-1px;margin-bottom:-1px;" align="center">
<th width="250"><?php echo $lang->performance->autographmyself;?></th><td colspan="3" width="441"><?php echo $get_master->staffsignature;?></td>
<th width="250"><?php echo $lang->performance->autographsuper;?></th><td colspan="3" width="390"><?php echo html::inputreview("supersignature",$get_master->supersignature,"class='input4  '",$get_master->status,$get_master->circlestatus);?> </td>
</tr>
