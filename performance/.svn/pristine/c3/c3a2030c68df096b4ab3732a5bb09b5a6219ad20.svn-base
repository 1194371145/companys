...
$lang->build->unlinkStory        = '移除产品';
$lang->build->unlinkBug          = '移除Bug';
$lang->build->stories            = '完成的产品';
...
$lang->build->finishStories = ' 本次共完成 %s 個产品';
