...
class commonModel extends model
{
    ...
    public static function printTopBar()
    {
        ...
        echo "<a href='#'>".date( "F j, Y, g:i a")."</a>";
        //echo "<div class='dropdown'>";
        //echo "<a href='javascript:;' data-toggle='dropdown'>" . $lang->help . " <span class='caret'></span></a>";
        
        //echo '<ul class='dropdown-menu pull-right'><li>' . html::a('javascript:;', $lang->manual, '', "class='open-help-tab'") . '</li></ul>';
        //echo "</div>";
    ...
    public static function printSearchBox()
    {
        ...
        {
             $searchObject = 'performance';
        }

        if(empty($lang->searchObjects[$searchObject])) $searchObject = 'performance';
        ...
        foreach($new as $key => $value)
        {
            ...
            { 
                ...
                if(substr_count($value, "\n") > 1     or 
                    ...
                    strpos('name', strtolower($key)) !== false)
                {
