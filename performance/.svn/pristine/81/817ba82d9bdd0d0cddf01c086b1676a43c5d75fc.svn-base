...
class baseRouter
{
    ...
    public function setClientLang($lang = '')
    {
        ...
        {
            $this->clientLang = "en";//$_COOKIE['lang']
        }
        elseif(isset($_SERVER['HTTP_ACCEPT_LANGUAGE']))
        {
            ...
            if(stripos($this->clientLang, 'hans')) $this->clientLang = 'en';
            if(stripos($this->clientLang, 'hant')) $this->clientLang = 'en';
        }
    ...
    public function setClientTheme($theme = '')
    {
        ...
        {
            $this->clientTheme = 'blackberry';//$_COOKIE['theme']
        }    
...
class super
{
    ...
    public function set($key, $value)
    {
        ...
        {
            $_SESSION[$key."performance"] = $value;
        }
    ...
    public function __get($key)
    {
        ...
        elseif($this->scope == 'session')
        {
            if(isset($_SESSION[$key."performance"])) return $_SESSION[$key."performance"];
            return false;
        }
        elseif($this->scope == 'env')
        {
