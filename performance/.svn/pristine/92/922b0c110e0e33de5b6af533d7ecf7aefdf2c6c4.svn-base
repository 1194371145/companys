...
$lang->tree->confirmRoot   = "模組的所屬{$lang->productCommon}修改，會關聯修改該模組下的产品、Bug、用例的所屬{$lang->productCommon}，以及{$lang->projectCommon}和{$lang->productCommon}的關聯關係。該操作比較危險，請謹慎操作。是否確認修改？";
