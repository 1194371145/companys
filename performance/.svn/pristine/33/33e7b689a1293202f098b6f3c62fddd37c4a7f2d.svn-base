...
$lang->action->objectTypes['story']       = '产品';
...
$lang->action->desc->confirmed      = '$date, 由 <strong>$actor</strong> 確認产品變動，最新版本為<strong>#$extra</strong>。' . "\n";
...
$lang->action->label->confirmed           = '確認了产品，';
$lang->action->label->bugconfirmed        = '確認了';
$lang->action->label->tostory             = '轉产品';
$lang->action->label->frombug             = '轉产品';
...
$lang->action->label->linkrelatedstory    = "關聯了相關产品";
$lang->action->label->unlinkrelatedstory  = "移除了相關产品";
$lang->action->label->subdividestory      = "細分了产品";
$lang->action->label->unlinkchildstory    = "移除了細分产品";
...
$lang->action->label->story       = '产品|story|view|storyID=%s';
...
$lang->action->search->objectTypeList['story']       = '产品';  
