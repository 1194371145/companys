...
$lang->release->batchUnlinkStory = "批量移除产品";
$lang->release->batchUnlinkBug   = "批量移除Bug";

$lang->release->confirmDelete      = "您確認刪除該release嗎？";
$lang->release->confirmUnlinkStory = "您確認移除該产品嗎？";
...
$lang->release->unlinkStory           = '移除产品';
$lang->release->unlinkBug             = '移除Bug';
$lang->release->stories               = '完成的产品';
$lang->release->bugs                  = '解決的Bug';
$lang->release->generatedBugs         = '遺留的Bug';
$lang->release->finishStories         = '本次共完成 %s 個产品';
...
$lang->release->exportTypeList['story']   = '产品';
