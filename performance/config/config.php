...
$config->projectCommonList['en'][0]    = 'Regiser User';
$config->projectCommonList['en'][1]    = 'Sprint';
$config->productCommonList['zh-cn'][0] = '产品分类';
$config->productCommonList['zh-cn'][1] = '注册';
$config->projectCommonList['zh-cn'][0] = '注册';
...
$config->default->theme  = 'blackberry';     // Default theme.
...
define('TABLE_PRODUCT',       '`' .'510_proclass`');
define('TABLE_PRODUCTOLD',       '`' .'510_proclass`');
define('TABLE_BRANCH',        '`' . $config->db->prefix . 'branch`');
define('TABLE_STORY',         '`' . $config->db->prefix . 'story`');
define('TABLE_STORYOLD',         '`510_procut`');
