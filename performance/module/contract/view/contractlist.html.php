...
<div id='contractTop'>
    ...
    <?php echo "<li id='allContract' ".$tabstyle['all'].">" . html::a(inlink("contractlist", "type=normal&status=all"), "All") . '</li>';?>
    <?php echo "<li id='agreeContract' ".$tabstyle['agree'].">" . html::a(inlink("contractlist", "type=normal&status=agree"), "Approved") . '</li>';?>
    <?php echo "<li id='pendingContract' ".$tabstyle['pending'].">" . html::a(inlink("contractlist", "type=normal&status=pending"), "Pending") . '</li>';?>
    <?php echo "<li id='modifyContract' ".$tabstyle['modify'].">" . html::a(inlink("contractlist", "type=normal&status=modify"), "Adjusted") . '</li>';?>
    <?php echo "<li id='rejectiveContract' ".$tabstyle['rejective'].">" .  html::a(inlink("contractlist", "type=normal&status=rejective"),"Rejected") . '</li>';?>
