...
<div id='fileform'>
  ...
  <table class='fileBox' id='fileBox\$i'>
    <tr>
      <td ><div class='form-control file-wrapper'><input type='file' name='{$filesName}[]' class='fileControl'  tabindex='-1' onchange='checkSizeAndType(this)'/></div></td>
      <td class='w-200px'><input type='text' name='{$labelsName}[]' class='form-control' placeholder='{$lang->file->label}' tabindex='-1' /></td>
	  <td class='w-100px'>
	  <select name='doctype[]' class='form-control' style='width:150px'>
	  <option value='datasheet'>Datasheet</option>
	  <option value='note'>Application Notes</option>
