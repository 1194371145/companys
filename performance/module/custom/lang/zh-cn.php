...
$lang->custom->notice->indexPage['product'] = "从8.2版本起增加了产品分类主页视图，是否默认进入产品分类主页？";
...
$lang->custom->productProject->relation['0_0'] = '产品分类 - 项目';
$lang->custom->productProject->relation['0_1'] = '产品分类 - 迭代';
