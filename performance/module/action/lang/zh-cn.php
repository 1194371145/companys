...
$lang->action->desc->confirmed      = '$date, 由 <strong>$actor</strong> 确认产品变动，最新版本为<strong>#$extra</strong>。' . "\n";
...
$lang->action->label->confirmed           = '确认了产品，';
$lang->action->label->bugconfirmed        = '确认了';
$lang->action->label->tostory             = '转产品';
$lang->action->label->frombug             = '转产品';
...
$lang->action->label->linkrelatedstory    = "关联了相关产品";
$lang->action->label->unlinkrelatedstory  = "移除了相关产品";
$lang->action->label->subdividestory      = "细分了产品";
$lang->action->label->unlinkchildstory    = "移除了细分产品";
