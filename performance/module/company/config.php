...
$config->company->devicecode->search['module']                   = 'device';

$config->company->devicecode->search['fields']['id']             = "ID";
$config->company->devicecode->search['fields']['account']             = "姓名";
$config->company->devicecode->search['fields']['mark']             = "成绩";


$config->company->devicecode->search['params']['id']             = array('operator' => 'include', 'control' => 'input',  'values' => '');
$config->company->devicecode->search['params']['account']             = array('operator' => 'include', 'control' => 'input',  'values' => '');
$config->company->devicecode->search['params']['mark']             = array('operator' => 'include', 'control' => 'input',  'values' => '');
