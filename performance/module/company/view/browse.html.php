...
<form action='<?php echo $this->createLink('user', 'batchEdit', "deptID=$deptID")?>' method='post' id='userListForm'>
  <table class='table table-condensed table-hover table-striped tablesorter table-fixed' id='userList'>
    ...
    <tr class='colhead'>
      ...
      <th><?php common::printOrderLink('role',     $orderBy, $vars, "Position");?></th>
      <th><?php common::printOrderLink('supervise',    $orderBy, $vars, "Supervisor");?></th>
       <th><?php common::printOrderLink('supersid',    $orderBy, $vars, "Superviser SID");?></th>
    ...
    <tr class='text-center'>
      ...
      <td><?php if(!common::printLink('user', 'edit', "userID=$user->id&from=company", $user->realname)) echo $user->realname;?></td>
      <td><?php echo $user->account;?></td>
      <td><?php echo $user->position;?></td>
      <td><?php echo $user->supervise;?></td>
       <td><?php echo $user->supersid;?></td>
