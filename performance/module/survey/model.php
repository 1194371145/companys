...
class surveyModel extends model
{
	...
	public function createsurvey()
	{
	    ...
	    if(empty($data->silergyyears[0]) || empty($data->workyears[0]))
		  	{
		  		die(js::error("Please complete the two choice questions about work experience on the top of the survey."));
		  	}
...
//		  	if(empty($data->silergyyears[0]) || empty($data->workyears[0]))
//		  	{
//		  		die(js::error("Please complete all the must-finished scoring items"));
//		  	}
//		  	if(empty($data->val1) || empty($data->val2) || empty($data->val3) || empty($data->val4) || empty($data->val5)
//		  	|| empty($data->val6) || empty($data->val7) || empty($data->val8) || empty($data->val9) || empty($data->val10)
//		  	|| empty($data->val11) || empty($data->val12) || empty($data->val13) || empty($data->val14) || empty($data->val15)
...
//	}
	public function thumbup()
	{
	   ...
	   if($art->re1=="hh" || $art->re2=="hh" || $art->re3=="hh" || $art->re4=="hh" || $art->re5=="hh"
	      || $art->re6=="hh" || $art->re7=="hh" || $art->re8=="hh")
       {
      	die(js::error("Please complete all the must-finished scoring items11"));
       }
	   if(empty($data->silergyyears[0]) || empty($data->workyears[0]))
	  	{
	  		die(js::error("Please complete all the must-finished scoring items"));
	    ...
	    if(empty($data->val1) && empty($data->val2) && empty($data->val3) && empty($data->val4) && empty($data->val5)
		 ...
		 $ptt -> xinsuggest1 = $art -> xinsuggest1;$ptt -> xinsuggest2 = $art -> xinsuggest2;$ptt -> xinsuggest3 = $art -> xinsuggest3;
