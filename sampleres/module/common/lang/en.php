...
$lang->zentaoPMS      = 'Silergy';
$lang->welcome        = "%s Sample Management System";
...
//l$ang->menu->project  = 'Project|project|index';
//$lang->menu->qa       = 'Test|qa|index';
//$lang->menu->doc      = 'Doc|doc|index';
//$lang->menu->report   = 'Report|report|index';
$lang->menu->sample       ="Sample|sample|index";
$lang->menu->mp       ="MP|mp|index";
$lang->menu->company  = 'Company|company|index';
$lang->menu->admin    = 'Admin|admin|index';
$lang->menu->sampleapp    = 'Sampleapp|sampleapp|getsamplelist';
...
$lang->mp->menu->index='Index|mp|index';
$lang->mp->menu->importbasicdata=array('link'=>'Import Basic Data|mp|importbasicdata|onlybody=yes','float'=>'right');
$lang->mp->menu->importoutdata=array('link'=>'Import Out Data|mp|importoutdata|onlybody=yes','float'=>'right');
$lang->mp->menu->importindata=array('link'=>'Import In Data|mp|importindata|onlybody=yes','float'=>'right');
/* Sample menu*/
