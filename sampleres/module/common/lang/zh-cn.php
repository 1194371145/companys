...
$lang->zentaoPMS      = '矽力杰';
$lang->welcome        = "『%s』$lang->colon 样品管理系统";
$lang->myControl      = "我的地盘";
...
$lang->menu->sample       = '工程样品|sample|index';
$lang->menu->mp           = '量产|mp|index';
$lang->menu->sampleout    ="申请记录|sampleout|out";
$lang->menu->company      = 'Company|company|index';
$lang->menu->admin        = '后台|admin|index';
$lang->menu->sampleapp    = 'Sample Application|sampleapp|getsamplelist';
...
$lang->admin->menu->template     = array('link' => 'TemPlate|admin|template');
$lang->admin->menu->sqjltbcx     = array('link' => '申请记录同步产线|admin|sqjltbcx','target'=>'hiddenwin');
$lang->admin->menu->sqjmp     = array('link' => '同步mp产线|admin|sqjmp');
$lang->admin->menu->sqjmpi     = array('link' => '同步mpi产线|admin|sqjmpi');
$lang->admin->menu->sample     = array('link' => '同步sample产线|admin|sample');
...
/* MP menu*/
$lang->mp=new stdClass();
$lang->mp->menu=new stdClass();
$lang->mp->menu->index=array('link'=>'首页|mp|index','alias'=>"editmp,viewmp");

$lang->mp->menu->importbasicdata=array('link'=>'导入基础数据|mp|importbasicdata|onlybody=yes','float'=>'right');
$lang->mp->menu->importindata=array('link'=>'导入入库数据|mp|importindata|onlybody=yes','float'=>'right');
$lang->mp->menu->async=array('link'=>'全表匹配Topmark|mp|async','float'=>'right');
/* Sample menu*/
$lang->sample=new stdClass();
$lang->sample->menu=new stdClass();
$lang->sample->menu->index=array('link'=>"首页|sample|index",'alias'=>"editsample,viewsample");
$lang->sample->menu->importbasicdata=array('link'=>'导入基础数据|sample|importbasicdata|onlybody=yes','float'=>'right');
$lang->sample->menu->asyncpeandphase=array("link"=>"同步Release数据|sample|asyncpeandphase","float"=>"right");

/* sampleapp menu */
$lang->sampleapp->menu->getsamplelist        = "Sample List|sampleapp|getsamplelist";
$lang->sampleapp->menu->createout            = "Sample Application|sampleapp|createout";
$lang->sampleapp->menu->demolist             = "DEMO List|sampleapp|demolist";
$lang->sampleapp->menu->importout            = array('link'=>"Import Sample|sampleapp|importout|onlybody=no",'float'=>'right');
$lang->sampleapp->menu->Sampletmp            = array('link'=>"Sample Template|sampleapp|Sampletmp",'float'=>'right');
$lang->sampleapp->menu->mappingfrom            = array('link'=>"同步产线|sampleapp|mappingfrom",'float'=>'right');


/* sampleout */
$lang->sampleout->menu->out="样品申请记录|sampleout|out";
$lang->sampleout->menu->demo="Demo申请记录|sampleout|demo";
$lang->sampleout->menu->pay="申请付费标示|sampleout|pay";
$lang->sampleout->menu->createout=array("link"=>"提交申请|sampleout|createout","alias"=>"vieweditout,viewout");
//$lang->sampleout->menu->mailsample="审核邮件|sampleout|mailsample";
//$lang->sampleout->menu->maildemo="DEMO邮件|sampleout|maildemo";
$lang->sampleout->menu->importout=array("link"=>"导入申请表|sampleout|importout|onlybody=yes","float"=>"right");
$lang->sampleout->menu->wareline=array("link"=>"库存警戒线|sampleout|wareline","float"=>"right");
