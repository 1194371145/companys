...
$(function()
		   {
		     //$("#wgc_module li:eq(3)").css('border-right','1px #999 solid');
			 //$("#wgc_module li:eq(5)").css('border-right','1px #999 solid');
			// $("#wgc_module li:eq(6)").css('border-right','1px #999 solid');
			 //$("#wgc_module li:eq(9)").css('border-right','1px #999 solid');
		   });
...
{
    $("#submenuimportout").modalTrigger({type: 'iframe', width:800});
});