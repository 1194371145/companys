...
<form method='post'>
  <table align='center' class='table-4 a-center'> 
    ...
    <tr>
      <th><?php echo $lang->team->account;?> <font style="color:#F00"> *</font></th>
...
<!--      <th>< ?php echo $lang->team->days;?></th>
    ...
    <tr>
      ...
      <td><input type='text' name='roles[]'    id='role<?php echo $key;?>'    value='<?php echo $member->role;?>' class='text-2' /><input type='hidden' name='modes[]' value='update' /></td>
<!--      <td><input type='text'   name='days[] '  id='days< ?php echo $key;?>'    value='< ?php echo $member->days;?>' class='text-2' /></td>
    ...
    <tr>
      ...
      <?php
	  $key0 = $i+1; 
	  echo html::select('roles[]', $lang->role, '', 'class="select-2" id=role'.$key0);?>
      <!--<input type='text' name='roles[]' id='role< ?php echo ($key + $i);?>' class='text-2' />-->
      <input type='hidden' name='modes[]' value='create' /></td>
