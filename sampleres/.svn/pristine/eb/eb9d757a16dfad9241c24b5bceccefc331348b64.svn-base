...
class router
{
    ...
    public function loadModule()
    {
        ...
        if ($moduleName == 'sampleapp' or $moduleName=='my') {
            $this->setClientLang('en');
        } else {
            $this->setClientLang('zh-cn');
        }
...
class super
{
    ...
    public function __get($key)
    {
        ...
        elseif($this->scope == 'session')
        {
            if(isset($_SESSION[$key."sample"])) return $_SESSION[$key."sample"];
            return false;
        }
        elseif($this->scope == 'env')
        {
